<?php
  ...
  class internode {
    ...
    function fetch_data($url) {
      ...
      curl_setopt($o, CURLOPT_USERAGENT, sprintf("internode.php/v.%d (Copyright 2004-2010 Intellectual Property Holdings Pty. Ltd.)", INTERNODE_VERSION ) );
	...
	if($i > 0) {
      ...
      $copyright = sprintf("Generated by internode.php v.%d - Copyright 2004 - 2010 Intellectual Property Holdings Pty. Ltd.", INTERNODE_VERSION );
